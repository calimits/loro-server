...
import { chatServiceController } from "../../../controllers-components/v1.0.0/ChatServiceControllerInstance.js";
import { auth } from "../../../middleware-component/v1.0.0/AuthMiddlewareInstance.js";
const ChatServiceRoutes = express.Router();
...
ChatServiceRoutes.put("/chats/update/description/:chatID", am.auth, cc.updateChatDescription); //update chat field (name, descrtiption)
